...
export default function HeroSection() {
   ...
   return (
      <section
         ref={containerRef}
         className="relative flex min-h-dvh w-full flex-col items-center justify-center overflow-hidden bg-(image:--gradient-hero) pt-15"
      >
         ...
         <div className="relative mx-auto flex h-full w-full max-w-7xl flex-1 flex-col justify-center z-10">
            <motion.div
               ...
               className="absolute left-0 top-12 z-40 flex w-full justify-between px-6 lg:px-8"
            >
