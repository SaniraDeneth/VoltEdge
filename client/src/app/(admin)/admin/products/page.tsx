         ...
         <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
               ...
               <p className="text-sm font-medium text-slate-500">
                  Manage your precision instrument inventory
               </p>
            </div>
                        ...
                        products.map((product) => (
                           ...
                           >
                              ...
                              <td className="px-6 py-4">
                                 <div className="flex items-center gap-2">
                                    <div
                                       className={`h-2 w-2 rounded-full ${product.countInStock > 10 ? 'bg-emerald-500' : product.countInStock > 0 ? 'bg-amber-500' : 'bg-rose-500'}`}
                                    />
                                    <span
                                       className={`text-sm font-bold ${product.countInStock === 0 ? 'text-rose-500' : 'text-slate-600'}`}
                                    >
