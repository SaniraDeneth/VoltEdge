...
export default function NotFound() {
   ...
   return (
      <main className="relative flex min-h-dvh w-full flex-col items-center justify-center overflow-hidden bg-background p-6 text-center">
         ...
         <div className="z-10 flex flex-col items-center">
            <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-4xl border border-border/50 bg-background/50 shadow-glow backdrop-blur-xl">
            ...
            <h1 className="font-display text-[8rem] font-black leading-none tracking-tighter sm:text-[12rem]">
               <span className="bg-(image:--gradient-accent) bg-clip-text text-transparent drop-shadow-sm">
                  404
               </span>
            </h1>
